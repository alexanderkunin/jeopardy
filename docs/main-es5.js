...
var AppComponent = /** @class */ (function () {
    function AppComponent(teamServiceService) {
...
var question_grid_component_1 = __webpack_require__(/*! ./question-grid/question-grid.component */ "./src/app/question-grid/question-grid.component.ts");
var question_viewer_component_1 = __webpack_require__(/*! ./question-viewer/question-viewer.component */ "./src/app/question-viewer/question-viewer.component.ts");
var announcement_component_1 = __webpack_require__(/*! ./announcement/announcement.component */ "./src/app/announcement/announcement.component.ts");
...
var Question = /** @class */ (function () {
    function Question(body, answer, points, color, activated) {
        this.body = body;
        this.answer = answer;
        this.points = points;
        this.color = color;
...
var Team = /** @class */ (function () {
    ...
    Team.ctorParameters = function () { return [
        { type: String }
    ]; };
    return Team;
}());
...
var core_1 = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
var QuestionGridComponent = /** @class */ (function () {
    function QuestionGridComponent(teamService) {
        this.teamService = teamService;
        this.questions = new Array();
        this.event = new rxjs_1.Subject();
    }
    QuestionGridComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.init();
    ...
    QuestionGridComponent.prototype.onSelect = function (question) {
        if (question.activated) {
            this.questionSelected = question;
        }
    };
    QuestionGridComponent.prototype.currentTeam = function () {
        return this.teamService.getCurrentTeam();
    };
    QuestionGridComponent.prototype.resetGame = function () {
        var _this = this;
        this.teamService.reset()
            .then(function () { return _this.init(); });
        ;
    };
    QuestionGridComponent.prototype.init = function () {
    ...
    QuestionGridComponent.prototype.completeGame = function () {
        this.questionSelected = null;
        this.noOfQestions = 0;
    };
    QuestionGridComponent.ctorParameters = function () { return [
        { type: team_service_1.TeamService }
    ]; };
...
Object.defineProperty(exports, "__esModule", { value: true });
var tslib_1 = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
var Question_1 = __webpack_require__(/*! ./../model/Question */ "./src/app/model/Question.ts");
var core_1 = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
var rxjs_1 = __webpack_require__(/*! rxjs */ "./node_modules/rxjs/_esm5/index.js");
var Team_1 = __webpack_require__(/*! ../model/Team */ "./src/app/model/Team.ts");
var QuestionViewerComponent = /** @class */ (function () {
    function QuestionViewerComponent() {
    }
    QuestionViewerComponent.prototype.ngOnInit = function () {
    };
    QuestionViewerComponent.prototype.onYes = function () {
        this.question.activated = false;
        this.event.next(this.question);
        this.question = null;
    };
    QuestionViewerComponent.prototype.onNo = function () {
        this.question.activated = false;
        this.event.next(0);
        this.question = null;
    };
...
var QuestionsService = /** @class */ (function () {
    ...
    QuestionsService.prototype.getQuestionsInCategories = function () {
...
var core_1 = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
var Team_1 = __webpack_require__(/*! ../model/Team */ "./src/app/model/Team.ts");
var questions_service_1 = __webpack_require__(/*! ./questions.service */ "./src/app/services/questions.service.ts");
var TeamService = /** @class */ (function () {
    ...
    TeamService.prototype.init = function () {
        if (!!localStorage.getItem('teams')) {
            this.categories = JSON.parse(localStorage.getItem('categories'));
            for (var _i = 0, _a = this.categories; _i < _a.length; _i++) {
                var cat = _a[_i];
                for (var _b = 0, _c = cat.questions; _b < _c.length; _b++) {
                    var q = _c[_b];
    ...
    TeamService.prototype.reset = function () {
        var _this = this;
        var p = new Promise(function (resolve, reject) {
            _this.teams = [new Team_1.Team('Team "Insulin"'), new Team_1.Team('Team "Glucose"')];
            _this.turn = 0;
            _this.questionService.getQuestionsInCategories().subscribe(function (cats) {
                ...
                for (var _i = 0, _a = _this.categories; _i < _a.length; _i++) {
                    ...
                    for (var _b = 0, _c = cat.questions; _b < _c.length; _b++) {
                        var q = _c[_b];
                        q.activated = true;
                        _this.numberOfQuestions += 1;
                    }
                }
                localStorage.setItem('categories', JSON.stringify(_this.categories));
                localStorage.setItem('teams', JSON.stringify(_this.teams));
                localStorage.setItem('turn', _this.turn.toString());
                resolve(true);
            }, function (error) { return reject(); });
        });
        return p;
    };
    TeamService.prototype.saveState = function () {
        localStorage.setItem('categories', JSON.stringify(this.categories));
        localStorage.setItem('teams', JSON.stringify(this.teams));
        localStorage.setItem('turn', this.turn.toString());
    };
    TeamService.prototype.answer = function (question) {
    ...
    TeamService.prototype.changeTurn = function () {
        if (this.turn === 0) {
            this.turn = 1;
        }
        else {
    ...
    TeamService.prototype.getCategories = function () {
        return this.categories;
    };
    TeamService.prototype.getTeams = function () {
        return this.teams;
    };
    TeamService.prototype.getNumberOfQuestions = function () {
